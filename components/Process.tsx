  ...
  return (
    <div className="">
      <button className="w-full relative inline-flex h-12 overflow-hidden rounded-lg p-[1px] md:w-60 md:mt-10">
        ...
        <span className="text-xl inline-flex h-full w-full cursor-pointer items-center justify-center rounded-lg bg-slate-950 px-7 py-2 font-medium text-white backdrop-blur-3xl gap-2">
          {" "}
          {order}
        </span>
      </button>
